...
extern char cfg_discord_token[128];
...
static void handleGetConfig() {
    ...
    snprintf(buf, 4096,
        ...
        "\"timezone\":\"%s\""
        "}",
        cfg_wifi_ssid, masked_pass, cfg_llm_provider, masked_key, cfg_model,
...
var f=['wifi_ssid','wifi_pass','llm_provider','api_key','model','device_name','api_base_url',
